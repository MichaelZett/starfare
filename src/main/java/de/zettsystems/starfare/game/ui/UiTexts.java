...
public final class UiTexts {
    ...
    public static final String REPLAY_HISTORICAL_NOTICE = "replay.historical.notice";
    public static final String REPLAY_FINAL_NOTICE = "replay.final.notice";
    public static final String REPLAY_UNAVAILABLE = "replay.unavailable";
    public static final String REPLAY_EVENT_MARK = "replay.event.mark";
    public static final String REPLAY_NEXT_EVENT = "replay.nextEvent";
    ...
    public static final String MAP_TRAVEL_FILTER = "map.travel.filter";
    public static final String MAP_TRAVEL_FILTER_PLACEHOLDER = "map.travel.filter.placeholder";
    public static final String MAP_TRAVEL_ARRIVAL_GROUP = "map.travel.arrivalGroup";
    public static final String MAP_TRAVEL_EMPTY = "map.travel.empty";
    public static final String MAP_LOGISTICS_FILTERS = "map.logistics.filters";
    public static final String MAP_LOGISTICS_FILTER_NET_INFLOW = "map.logistics.filter.netInflow";
    public static final String MAP_LOGISTICS_FILTER_FREE_CAPACITY = "map.logistics.filter.freeCapacity";
    public static final String MAP_LOGISTICS_FILTER_BOTTLENECK = "map.logistics.filter.bottleneck";
    public static final String MAP_LOGISTICS_FILTER_NO_OUTGOING = "map.logistics.filter.noOutgoing";
    public static final String MAP_LOGISTICS_DELIVERY_BOTTLENECK = "map.logistics.deliveryBottleneck";
    public static final String MAP_LOGISTICS_NEXT_DELIVERY = "map.logistics.nextDelivery";
    ...
    public static final String LOBBY_CARD_OPEN_SEATS = "lobby.card.openSeats";
    public static final String LOBBY_JOIN_GAME = "lobby.join.game";
    public static final String LOBBY_JOIN_SEATS = "lobby.join.seats";
    public static final String LOBBY_JOIN_NO_SEATS = "lobby.join.noSeats";
    ...
    public static final String LOBBY_FIELD_GAME_NAME = "lobby.field.gameName";
    public static final String LOBBY_GAME_NAME_REQUIRED = "lobby.gameName.required";
    public static final String LOBBY_WIZARD_REVIEW = "lobby.wizard.review";
    public static final String LOBBY_WIZARD_BACK = "lobby.wizard.back";
    public static final String LOBBY_SUMMARY_NAME = "lobby.summary.name";
    public static final String LOBBY_SUMMARY_VISIBILITY = "lobby.summary.visibility";
    public static final String LOBBY_SUMMARY_SYSTEMS = "lobby.summary.systems";
    public static final String LOBBY_SUMMARY_PLAYERS = "lobby.summary.players";
    public static final String LOBBY_SUMMARY_GALAXY = "lobby.summary.galaxy";
    public static final String LOBBY_SUMMARY_GARRISON = "lobby.summary.garrison";
    public static final String LOBBY_SUMMARY_NEUTRAL_PRODUCTION = "lobby.summary.neutralProduction";
    ...
    public static final String LOBBY_SUMMARY_DISABLED = "lobby.summary.disabled";
    public static final String LOBBY_SUMMARY_OBSERVERS_ALLOWED = "lobby.summary.observersAllowed";
    public static final String LOBBY_SUMMARY_OBSERVERS_BLOCKED = "lobby.summary.observersBlocked";
    public static final String LOBBY_SUMMARY_REENTRY_ALLOWED = "lobby.summary.reentryAllowed";
    public static final String LOBBY_SUMMARY_REENTRY_BLOCKED = "lobby.summary.reentryBlocked";
    public static final String LOBBY_SUMMARY_HUMAN = "lobby.summary.human";
    public static final String LOBBY_SUMMARY_AI = "lobby.summary.ai";
    public static final String LOBBY_SUMMARY_SCHEMATIC = "lobby.summary.schematic";
    public static final String LOBBY_COLOR_COBALT = "lobby.color.cobalt";
    public static final String LOBBY_COLOR_AMBER = "lobby.color.amber";
    public static final String LOBBY_COLOR_EMERALD = "lobby.color.emerald";
    public static final String LOBBY_COLOR_VERMILION = "lobby.color.vermilion";
    public static final String LOBBY_COLOR_MAGENTA = "lobby.color.magenta";
    public static final String LOBBY_COLOR_SKY = "lobby.color.sky";
    public static final String LOBBY_COLOR_GOLD = "lobby.color.gold";
    public static final String LOBBY_COLOR_CRIMSON = "lobby.color.crimson";
    public static final String LOBBY_COLOR_TURQUOISE = "lobby.color.turquoise";
    public static final String LOBBY_COLOR_VIOLET = "lobby.color.violet";
    public static final String STATISTICS_BALANCE = "statistics.balance";
    public static final String STATISTICS_BALANCE_LABEL = "statistics.balance.label";
    public static final String STATISTICS_BALANCE_LEGEND = "statistics.balance.legend";
    public static final String STATISTICS_DRAWS = "statistics.draws";
    public static final String STATISTICS_OPPONENTS = "statistics.opponents";
    public static final String STATISTICS_OPPONENTS_EMPTY = "statistics.opponents.empty";
    ...
    public static final String ROUND_NEXT_OPEN_BATTLE = "round.nextOpenBattle";
    public static final String ROUND_OPEN_BATTLES = "round.openBattles";
    ...
    public static final String PRESENCE_STATUS_ONLINE = "presence.status.online";
    public static final String PRESENCE_ACTIONS_LABEL = "presence.actions.label";
    ...
    public static final String ARCHIVE_RESULT_FILTER = "archive.result.filter";
    public static final String ARCHIVE_RESULT_ALL = "archive.result.all";
    public static final String ARCHIVE_RESULT_VICTORY_FILTER = "archive.result.victories";
    public static final String ARCHIVE_RESULT_DEFEAT_FILTER = "archive.result.defeats";
    public static final String ARCHIVE_RESULT_NO_WINNER_FILTER = "archive.result.noWinnerFilter";
    public static final String ARCHIVE_RESULT_VICTORY = "archive.result.victory";
    public static final String ARCHIVE_RESULT_DEFEAT = "archive.result.defeat";
    public static final String ARCHIVE_RESULT_NO_WINNER = "archive.result.noWinner";
    public static final String ARCHIVE_NOT_A_PLAYER = "archive.notAPlayer";
    public static final String GAME_OUTCOME_PERSONAL_VICTORY = "gameOutcome.personalVictory";
    public static final String GAME_OUTCOME_PERSONAL_DEFEAT = "gameOutcome.personalDefeat";
    public static final String GAME_OUTCOME_REVIEW = "gameOutcome.review";
    public static final String GAME_OUTCOME_LOBBY = "gameOutcome.lobby";

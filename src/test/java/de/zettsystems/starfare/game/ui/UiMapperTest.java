...
class UiMapperTest {
    ...
    void systemLabelUsesVisibility() {
        VisibleSystem visible = new VisibleSystem(1, "S1", 0, 0, 1, 4, 2, true, "#fff", 1, false, null);
        VisibleSystem fog = new VisibleSystem(2, "S2", 0, 0, null, null, null, false, null, null, false, null);
    ...
    void systemTooltipUsesLastSeenOrNoSight() {
        VisibleSystem visible = new VisibleSystem(1, "S1", 0, 0, 1, 4, 2, true, "#fff", 3, false, null);
        VisibleSystem lastSeen = new VisibleSystem(2, "S2", 0, 0, null, null, null, false, null, 5, false, null);
        VisibleSystem noSight = new VisibleSystem(3, "S3", 0, 0, null, null, null, false, null, null, false, null);
    ...
    void toFleetViewsMapsSystemNames() {
        VisibleSystem s1 = new VisibleSystem(1, "Alpha", 0, 0, 1, 4, 2, true, "#fff", 1, false, null);
        VisibleSystem s2 = new VisibleSystem(2, "Beta", 0, 0, null, null, null, false, null, 1, false, null);
